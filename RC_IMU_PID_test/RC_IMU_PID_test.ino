...
//############################################################################
  ...
  //******************************PID CALC***************************************// 
  //******************************PID CALC***************************************// 
  Compute_pitch((pitchValue/2),pitch1);
  Compute_roll((rollValue/2),roll1);
  Compute_yaw(0,yaw1);
  ...
  if(bUpdateFlags & THROTTLE_FLAG)
  {
      ...
      Brushless_1.writeMicroseconds(unThrottleIn-(Output_pitch*unThrottleIn*0.1));
      Brushless_2.writeMicroseconds(unThrottleIn+(Output_roll*unThrottleIn*0.1));
      Brushless_3.writeMicroseconds(unThrottleIn+(Output_pitch*unThrottleIn*0.1));
      Brushless_4.writeMicroseconds(unThrottleIn-(Output_roll*unThrottleIn*0.1));
